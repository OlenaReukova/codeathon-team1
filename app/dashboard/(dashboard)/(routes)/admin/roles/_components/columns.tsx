    ...
    cell: ({ row }) => {
      return (
        <div className='flex items-center gap-2'>
          <Avatar>
            <AvatarImage
              src={row.original.publicUserData?.imageUrl}
              sizes='sm'
            />
            <AvatarFallback>
              {row.original.publicUserData?.identifier}
            </AvatarFallback>
          </Avatar>
          <span>
            {row.original.publicUserData?.firstName +
              ' ' +
              row.original.publicUserData?.lastName}
          </span>
        </div>
      );
    },
