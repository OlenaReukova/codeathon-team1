...
- **Clerk**: For secure authentication.[Clerk](https://clerk.com/)
- **PayPal**: To handle secure payments.[PayPal](https://developer.paypal.com/home/)
- **shadcn/ui**: Designed component library for frontend.[shadcn/ui](https://ui.shadcn.com/)
- **AG Grid Integrated Charts**: For Reports and Dashboards Page.[AG charts](https://www.ag-grid.com/charts/)
